...
export const TOGGLE_VISITED_POINT = "Wanderlist/points/TOGGLE_VISITED_POINT";
...
export function toggleIsVisited(id) {
  return ({ type: TOGGLE_VISITED_POINT, id: id })
}
...
export function listPoints() {
  response = [
    ...
    {"id": 13,"country":"Japan", "title":"Matsusaka Beef", "isVisited":false, "image":"https://uproxx.files.wordpress.com/2016/07/kobe.jpg?quality=95&w=650", "area":"Mie", "isFavorite": false, "latitude":34.5773156,  "longitude":136.5289148, "UNESCO":false, "tags":["Matsusaka","Wagyu","High-class","Expensive"], "category":"Food","description":"Most high-end beef available in Japan. The restaurant of Wadakin in Matsusaka owns the farm where cows are luxuriously treated."}
    ]
